...
class PemberkasanController extends Controller
{
    ...
    public function notaDinasPenyerahan($kasus_id)
    {
        ...
        $template_document->setValues(array(
            ...
            'nomor_1' => $pemberkasan->no_nota_dinas_penyerahan_bp3kepp,
            'tanggal_1' => Carbon::parse($pemberkasan->tgl_nota_dinas_penyerahan_bp3kepp)->translatedFormat('d F Y'),
            'nomor_3' => $pemberkasan->no_nota_dinas_penyerahan_hasil_perbaikan,
            'tanggal_3' => Carbon::parse($pemberkasan->tgl_nota_dinas_penyerahan_hasil_perbaikan)->translatedFormat('d F Y'),
            'no_nota_dinas_penyerahan' => $pemberkasan->no_nota_dinas_penyerahan,
            'perihal' => $kasus->perihal,
            'tim' => $disposisi->tim,
