    ...
    <div class="row form-control">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                ...
                <input type="text" name="name" class="form-control border-dark" id="name" placeholder="Nama"
                    value="{{ isset($penyidik) ? $penyidik->name : '' }}">
            </div>
            <div class="col-lg-6 mb-3">
                <label for="wujud_perbuatan" class="form-label">NRP</label>
                <input type="number" name="nrp" class="form-control border-dark" id="nrp" placeholder="NRP"
                ...
                <select name="id_pangkat" id="id_pangkat" class="form-control">
                    ...
                    @foreach ($pangkats as $pangkat)
                        <option value="{{ $pangkat->id }}"
                            @if (isset($penyidik)) @if ($penyidik->id_pangkat == $pangkat->id)
                                        "selected"; @endif
                            @endif
                            >{{ $pangkat->name }}</option>
                    @endforeach
            ...
            <div class="col-lg-6 mb-3">
                ...
                <select name="tim" id="tim" class="form-control">
                    ...
                    @for ($i = 0; $i < count($tims); $i++)
                        <option value="{{ $tims[$i] }}"
                            @if (isset($penyidik)) @if ($penyidik->tim == $tims[$i])
                                            "selected"; @endif
                            @endif
                            >{{ $tims[$i] }}</option>
                    @endfor
            ...
            <div class="col-lg-6 mb-3">
                ...
                <select class="form-control" name="fungsional" id="fungsional">
                    ...
                    <option value="Akreditor Utama"
                        @if (isset($penyidik)) @if ($penyidik->fungsional == 'Akreditor Utama')
                                    "selected"; @endif
                        @endif
                        >Akreditor Utama</option>
                    <option value="Akreditor Madya"
                        @if (isset($penyidik)) @if ($penyidik->fungsional == 'Akreditor Madya')
                                    "selected"; @endif
                        @endif
                        >Akreditor Madya</option>
                    <option value="Anggota"
                        @if (isset($penyidik)) @if ($penyidik->fungsional == 'Anggota')
                                    "selected"; @endif
                        @endif
                        >Anggota</option>
                </select>
            ...
            <div class="col-lg-6 mb-3">
                ...
                <input type="text" id="kesatuan" name="kesatuan" class="form-control border-dark" placeholder="Kesatuan"
                    value="{{ isset($penyidik) ? $penyidik->kesatuan : '' }}">
            </div>
